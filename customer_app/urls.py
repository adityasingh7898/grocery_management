...
from customer_app.views import customer_register_view,customer_list_view,customer_login_view,customer_home_view,customer_logout_view,forgot_pwd_view,change_pwd_view,customer_otp_view,login_demo_view
